...
index: 1
metaDescription: 'How Lasse Collin created the Tukaani Project in 2005, adopted the LZMA algorithm to compress Slackware Linux, and built what would become XZ Utils.'
---
...
Logging on to the internet, he informed his friends of the plan. They jumped on board and began brainstorming immediately. Naturally, any good project needed a good project name and, after much deliberation, they settled on naming it the _Tukaani Project_, hence also calling the distro _Tukaani Linux_. Tukaani is Finnish for a toucan, so Lasse's friend Ville Koskinen designed a fitting mascot for the project - Bob the toucan.
