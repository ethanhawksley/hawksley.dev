...
It's been 4 months since [my first post](https://hawksley.dev/blog/building-astro-blog) where I described building this site, and Wakatime estimates I've spent ~100 hours coding now, not including time spent researching and testing. Since then, this site has been receiving plenty of polish, including the addition of JSON-LD on each page.
...
```json
{
  ...
  "name": "Elsewhere",
  "description": "Online profiles of Ethan Hawksley, computer science student at the University of Warwick and author of The Second Maintainer.",
  "primaryImageOfPage": "https://hawksley.dev/ethan-hawksley.jpg"
}
```
